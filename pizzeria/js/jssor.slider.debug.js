...
var $JssorDebug$ = new function () {
    ...
    var b = this, rb = /\S+/g, C = 1, ab = 2, eb = 3, db = 4, ib = 5, D, j = 0, c = 0, k = 0, q = 0, r = 0, u = navigator, mb = u.appName, f = u.userAgent, p = document.documentElement, h = parseFloat;

    function Ab() {
        if (!D) {
            D = {$Touchable: "ontouchstart" in window || "createTouch" in document};
            var a;
    ...
    var F = {$Rotate: ["rotate"], $RotateX: ["rotateX"], $RotateY: ["rotateY"], $SkewX: ["skewX"], $SkewY: ["skewY"]};
    if (!y())F = v(F, {$ScaleX: ["scaleX", 2], $ScaleY: ["scaleY", 2], $TranslateZ: ["translateZ", 1]});
    function G(d, a) {
        var b = "";
        if (a) {
            if (i() && c && c < 10) {
    ...
    b.$CssScale = function (a, b) {
        if (i() && k < 9 || k < 10 && K())a.style.zoom = b == 1 ? "" : b; else {
            var c = E(a), f = "scale(" + b + ")", e = a.style[c], g = new RegExp(/[\s]*scale\(.*?\)/g), d = t(e, [g], f);
            a.style[c] = d
        }
    };
    var gb = 0, bb = 0;
    b.$WindowResizeFilter = function (b, a) {
        return I() ? function () {
            var f = true, c = K() ? b.document.body : b.document.documentElement;
            if (c) {
                var e = c.offsetWidth - gb, d = c.offsetHeight - bb;
                if (e || d) {
                    gb += e;
                    bb += d
                } else f = false
    ...
    function n(h, k) {
        ...
        n = function (g, f) {
            ...
            if (f.$Transform)if (d)pb(b.$CreateCallback(null, G, g, f)); else a(g, f)
        };
        b.$SetStyleTransform = G;
        if (d)b.$SetStyleTransform = n;
        if (f)b.$SetStyleTransform = a; else if (!c)a = G;
        b.$SetStyles = n;
        n(h, k)
    }
    ...
    b.$Cast = function (f, g, q, h, s, t, i) {
        ...
        if (f) {
            a = {};
            for (var c in g) {
                var u = t[c] || 1, p = s[c] || [0, 1], b = (q - p[0]) / p[1];
                b = Math.min(Math.max(b, 0), 1);
                b = b * u;
                var o = Math.floor(b);
                if (b != o)b -= o;
                var d = h.$Default || $JssorEasing$.$EaseSwing, e, v = f[c], k = g[c];
...
var $JssorSlideshowFormations$ = window.$JssorSlideshowFormations$ = new function () {
    ...
    function Tb(c, b) {
        var a = j > 0 ? j : H, d = sb * b * (a & 1), e = tb * b * (a >> 1 & 1);
        Db(c, d, e)
    }
    ...
    b.$GetVirtualIndex = function (a) {
        var c = Math.ceil(f(T / Ub)), b = f(a - e + c);
        if (b > h) {
    ...
    var H = a.$PlayOrientation & 3, mc = (a.$PlayOrientation & 4) / -4 || 1, w = a.$SlideshowOptions, v = $Jssor$.$Extend({
    ...
    var ec = 0, e = -1, pb, kb, d = D.length, y = a.$SlideWidth || hb, x = a.$SlideHeight || gb, Qb = a.$SlideSpacing, sb = y + Qb, tb = x + Qb, Ub = H & 1 ? sb : tb, h = Math.min(a.$Cols, d), V, j, z, rb, K = [], Lb, Nb, Jb, Vb, vc, F, q = a.$PauseOnHover, fc = a.$AutoPlayInterval, Pb = a.$SlideDuration, ib, lb, T, Mb = h < d, p = Mb ? a.$Loop : 0, P, B, r = 1, E, n, J, mb = 0, nb = 0, t, R, S, xb, i, L, l, ob = new hc, Q, Eb = [];
...
var $JssorCaptionSlideo$ = window.$JssorCaptionSlideo$ = function (j, c, i) {
    ...
    function n(c, d, a) {
        $Jssor$.$Each(d, function (f) {
            var d = g(f), e = $Jssor$.$FormatEasings(d.$Easing);
            if (d.$Left) {
                d.$MoveX = d.$Left;
                e.$MoveX = e.$Left;
                delete d.$Left
