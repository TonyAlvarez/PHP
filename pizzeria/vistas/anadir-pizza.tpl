...
<div class="container centrar">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <h1 class="page-header">Añadir pizza</h1>
            ...
            <form method="POST" class="form-horizontal" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="avatar">Imagen de la pizza</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <button id="enviar" name="enviar" class="btn btn-success">Añadir pizza</button>
                        </div>
                    </div>
